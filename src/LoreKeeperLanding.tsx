...
function PlatformIcon({ platform }: { platform: Platform }) {
  ...
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24">
      <path
        d="M12 2.7c-2.52 0-4.38 2.1-4.38 5.05 0 1.08.24 2.03.64 2.88-1.28 1.07-2.2 2.83-2.2 4.74 0 .72.13 1.38.38 1.98-.7.5-1.34 1.22-1.56 2.12-.13.52.25 1 .79 1h4.18c.7.43 1.42.65 2.15.65s1.45-.22 2.15-.65h4.18c.54 0 .92-.48.79-1-.22-.9-.86-1.62-1.56-2.12.25-.6.38-1.26.38-1.98 0-1.91-.92-3.67-2.2-4.74.4-.85.64-1.8.64-2.88C16.38 4.8 14.52 2.7 12 2.7Zm-1.58 4.24c.49 0 .88.42.88.94s-.39.94-.88.94-.89-.42-.89-.94.4-.94.89-.94Zm3.16 0c.49 0 .89.42.89.94s-.4.94-.89.94-.88-.42-.88-.94.39-.94.88-.94ZM9.16 13.52c.64.55 1.62.88 2.84.88s2.2-.33 2.84-.88c.58.68.94 1.65.94 2.66 0 1.88-1.54 3.26-3.78 3.26s-3.78-1.38-3.78-3.26c0-1.01.36-1.98.94-2.66Z"
        fill="currentColor"
      />
    </svg>
  );
